      ...
      <div className="max-w-md w-full space-y-4">
        ...
        <div className="bg-white/80 backdrop-blur-sm border-2 border-white/50 rounded-3xl shadow-2xl p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Create admin account for dashboard access</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/admin/login" className="text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200">
                Login
              </Link>
            </p>
          </div>
