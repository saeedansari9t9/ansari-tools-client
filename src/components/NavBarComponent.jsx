...
const NavBarComponent = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 backdrop-blur-md border-b shadow-lg" style={{ backgroundColor: 'var(--color-dark)', borderColor: 'var(--color-mid-light)' }}>
      ...
      >
          <div className="flex flex-col h-full backdrop-blur-2xl" style={{ backgroundColor: 'var(--color-dark)' }}>
            {/* Mobile Header */}
            <div className="flex items-center justify-between p-4 border-b border-white/20 backdrop-blur-sm flex-shrink-0">
              <div className="flex items-center space-x-3">
                ...
                /> */}
                <span className="text-xl font-bold bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">ANSARI TOOLS</span>
              </div>
              <button
            ...
            {isAuthenticated && (
              <div className="px-4 py-4 border-b border-white/20" style={{ backgroundColor: 'var(--color-mid-dark)' }}>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(to right, var(--color-mid-light), var(--color-light))' }}>
            ...
            <div className="flex-1 px-4 py-6 backdrop-blur-xl overflow-y-auto min-h-0" style={{ backgroundColor: 'var(--color-dark)' }}>
                ...
                {isAuthenticated && (
                  <>
                    <li className="pt-2 pb-4 border-b border-white/20">
                      <p className="px-4 text-sm font-semibold text-blue-300 uppercase tracking-wider">Admin Panel</p>
                    </li>
                    <li>
                      <Link
                        to="/admin"
                    ...
                    <li className="pt-4 pb-2 border-b border-white/20">
                      <p className="px-4 text-sm font-semibold text-blue-300 uppercase tracking-wider">Website Pages</p>
                    </li>
                    ...
                    <li>
                      <div className="relative" ref={websiteRef}>
                        ...
                        >
                          ...
                          <ChevronDown className={`w-5 h-5 transition-transform duration-200 ${websiteDropdown ? 'rotate-180' : ''}`} />
                        </button>
