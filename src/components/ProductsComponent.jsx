...
export default function ProductsComponent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4" style={{ backgroundColor: 'var(--color-light)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div className="relative w-full lg:w-80">
              <div className="relative bg-gray-50 rounded-lg border border-gray-300 hover:border-gray-400 focus-within:border-blue-500 transition-all duration-200">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-transparent rounded-lg focus:outline-none placeholder-gray-500 text-gray-900 font-medium focus:ring-2 focus:ring-green-800"
                />
                {searchTerm && (
                  <button
            ...
            <div className="flex items-center gap-4 w-full lg:w-auto justify-end">
              ...
              <div className="hidden lg:flex items-center gap-4">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border-2 border-gray-200 hover:border-green-700 focus:border-green-500 focus:ring-2 focus:ring-green-100 rounded-lg px-4 py-2.5 pr-10 text-sm font-medium text-gray-700 cursor-pointer min-w-[150px] shadow-sm hover:shadow-md transition-all duration-200"
                  >
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border-2 border-gray-200 hover:border-green-700 focus:border-green-500 focus:ring-2 focus:ring-green-100 rounded-lg px-4 py-2.5 pr-10 text-sm font-medium text-gray-700 cursor-pointer min-w-[130px] shadow-sm hover:shadow-md transition-all duration-200"
                  >
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white border-2 border-gray-200 hover:border-green-700 focus:border-green-500 focus:ring-2 focus:ring-green-100 rounded-lg px-4 py-2.5 pr-10 text-sm font-medium text-gray-700 cursor-pointer min-w-[160px] shadow-sm hover:shadow-md transition-all duration-200"
                >
              ...
              <button
                ...
                className="lg:hidden flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors duration-200 hover:opacity-90"
          ...
          {/* Mobile Filters */}
          {showFilters && (
            <div className="lg:hidden mt-6 p-6 bg-gray-50 rounded-xl border border-gray-200 shadow-lg space-y-4">
              ...
              <div className="relative">
                ...
                <select
                  value={filterBy.category}
                  onChange={(e) => setFilterBy({ ...filterBy, category: e.target.value })}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-200 hover:border-green-700 focus:border-green-700 focus:ring-2 focus:ring-green-100 rounded-lg text-sm font-medium text-gray-700 shadow-sm transition-all duration-200"
                >
                  <option value="all" className="font-medium">All Categories</option>
                  <option value="AI Tools" className="font-medium">AI Tools</option>
                  <option value="Design Tools" className="font-medium">Design Tools</option>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-5 gap-3 sm:gap-4 lg:gap-5">
          {loading ? (
            ...
            currentProducts.map((product) => (
              <div
                key={product.id}
                className={`bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group cursor-pointer ${hoveredCard === product.id ? "transform -translate-y-1" : ""
                  }`}
              ...
              >
                ...
                <Link to={`/product/${product.id}`} className="relative overflow-hidden aspect-square block">
                  ...
                  <div className="absolute top-1.5 left-1.5 sm:top-2 sm:left-2 lg:top-2.5 lg:left-2.5">
                    <span className="text-white text-xs font-semibold px-1 py-0.5 sm:px-1.5 sm:py-0.5 lg:px-2 lg:py-1 rounded-full" style={{ backgroundColor: 'var(--color-dark)' }}>
                      {product.badge}
                    </span>
                  </div>
                  {/* Quick View Button */}
                ...
                <div className="p-2 sm:p-3 lg:p-2.5">
                  ...
                  <Link to={`/product/${product.id}`}>
                    <h3 className="text-sm sm:text-base lg:text-sm font-semibold text-gray-900 mb-1 sm:mb-1.5 lg:mb-1 line-clamp-1 transition-colors cursor-pointer">
                      {product.name}
                    </h3>
                  </Link>
                  ...
                  <div className="flex gap-1 sm:gap-1.5 lg:gap-1">
                    <button
                      ...
                      className="w-full text-white py-1 sm:py-1.5 lg:py-1 px-2 sm:px-3 lg:px-2 rounded-lg font-medium text-xs transition-colors duration-200 flex items-center justify-center gap-1 hover:opacity-90"
                      style={{ backgroundColor: 'var(--color-dark)' }}
                    >
          ...
          <div className="flex justify-center items-center mt-16 mb-8">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-3 rounded-lg bg-white border border-gray-200 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gray-50 flex items-center justify-center min-w-[50px]"
              >
                <svg className="w-5 h-5 text-gray-600" style={{ color: 'var(--color-dark)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg font-semibold text-sm ${currentPage === page
                        ? 'text-white'
                        : 'text-gray-700 hover:bg-gray-50'
                        }`}
                      style={currentPage === page ? { backgroundColor: 'var(--color-dark)' } : {}}
                    >
                      {page}
                    </button>
                  );
